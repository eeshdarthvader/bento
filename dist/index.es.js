...
var Padding$1 = React.memo(Padding);
...
var Margin$1 = React.memo(Margin);
...
var Spacer$1 = React.memo(Spacer);
...
var IconMap = function IconMap(_ref) {
  ...
  switch (icon) {
    case 'plus':
      return React.createElement(SvgPlus, props);

    case 'minus':
      return React.createElement(SvgMinus, props);

    case 'triangle-down':
      return React.createElement(SvgTriangleDown, props);

    case 'calendar':
      return React.createElement(SvgCalendar, props);

    case 'tick':
      return React.createElement(SvgTick, props);

    case 'cross':
      return React.createElement(SvgCross, props);

    case 'checkbox-circle':
      return React.createElement(SvgCheckboxCircle, props);

    case 'circle-outline':
      return React.createElement(SvgCircleOutline, props);

    case 'circle-selected':
      return React.createElement(SvgCircleSelected, props);

    case 'avatar-man':
      return React.createElement(SvgAvatarMan, props);

    case 'avatar-woman':
      return React.createElement(SvgAvatarWoman, props);

    case 'avatar-girl':
      return React.createElement(SvgAvatarGirl, props);

    case 'avatar-boy':
      return React.createElement(SvgAvatarBoy, props);

    case 'avatar-infant':
      return React.createElement(SvgAvatarInfant, props);

    case 'star':
      return React.createElement(SvgStar, props);

    case 'clock':
      return React.createElement(SvgClock, props);

    case 'call':
      return React.createElement(SvgCall, props);
...
var Icon = function Icon(_ref2) {
  ...
  return React.createElement(IconMap, _extends({
    onClick: handleClick
  }, props));
};
...
var Field = function Field(props) {
  ...
  }, otherProps)), iconright && React.createElement(Icon, {
    icon: iconright,
...
var Divider = function Divider(props) {
  ...
  }, additionalProps)), props.text && React.createElement("div", _extends({
...
var Counter = function Counter(_ref) {
  ...
  }, React.createElement("li", null, React.createElement(Icon, {
    icon: "minus",
    width: "24",
    height: "24",
  ...
  }, value), React.createElement("li", null, React.createElement(Icon, {
    icon: "plus",
    width: "24",
    height: "24",
    className: plusClass,
...
var index$4 = React.memo(StarRating);
...
var Collapse = function Collapse(props) {
  return React.createElement(CollapsePose, {
    pose: props.pose,
...
var Fade = function Fade(props) {
  return React.createElement(FadePose, {
    pose: props.pose,
    className: classNames(props.className)
  }, props.children);
};

export { index$1 as Badge, index$3 as Banner, index$2 as Button, Checkbox$1 as Checkbox, Col$1 as Col, Collapse, Container$1 as Container, Counter, index as Divider, Fade, Field$1 as Field, Icon, Label$1 as Label, Margin$1 as Margin, NavItem, NavList, Padding$1 as Padding, index$4 as Rating, index$5 as Repeat, Row$1 as Row, Select$1 as Select, Spacer$1 as Spacer, TripAdvisorRating as TA, Textarea$1 as Textarea };
