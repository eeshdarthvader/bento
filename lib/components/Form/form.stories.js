    ...
    return (
      <div className="cont storybook">
        <div className="block">
          ...
          <div className="demo">
            <div>
              <Switcher value="tab_2">
                <Switcher.Tab value="tab_1" selected>Tab 1</Switcher.Tab>
                <Switcher.Tab value="tab_2">Tab 2</Switcher.Tab>
                <Switcher.Tab value="tab_3"></Switcher.Tab> 
              </Switcher>
            </div>
          </div>
        </div>
