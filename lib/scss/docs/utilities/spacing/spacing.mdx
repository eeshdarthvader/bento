...
<Sandbox>
    <Sandbox.Preview>
      ...
      <Sandbox.Code>
            <div className="bg-primary-400 mr-2 mt-12 ml-4">
            </div>
  </Sandbox.Code>
</Sandbox>
...
<Sandbox>
    <Sandbox.Preview>
        <div className="bs-auto br-no-repeat w-100p" style={{ height: '50px'}}>
            <div className="bs-solid">
                <div className="bg-primary-400 c-grey-80 pt-4 pb-1 pl-1 pr-2">This is a box with some padding applied</div>
            </div>
        </div>
    </Sandbox.Preview>
      <Sandbox.Code>
            <div className="bg-primary-400 pt-4 pb-1 pl-1 pr-2">
            </div>
  </Sandbox.Code>
</Sandbox>